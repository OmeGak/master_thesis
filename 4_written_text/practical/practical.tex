...
% define coordinates
\draw ($(\radij,0)$) coordinate (Release) node{$\bullet$} node[above right](Release){};

\draw ($(0,0)!3cm!(4,3)$) coordinate (Interaction) node{$\bullet$} node[above right](Interaction){$P$};
  ...
  \draw    pic["$\alpha$", draw=red, ->, angle eccentricity=1.0, angle radius=1cm]
